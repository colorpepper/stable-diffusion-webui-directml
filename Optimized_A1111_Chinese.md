...
# 	具备AMD独立显卡的平台
https://www.amd.com/zh-hans/graphics/radeon-rx-graphics
# 	驱动程序AMD Software: Adrenalin Edition 23.7.2或更高版本
...
在弹出的WebUI窗口中，转到Olive优化选项卡并点击优化按钮
 
选择如图所示的模型
 
进入’txt2img’开始生成第一张图片吧
 
运行在默认PyTorch路径下，AMD Radeon RX 7900 XTX的推理能力为1.22 iterations/second
运行在Microsoft Olive优化模型下，AMD Radeon RX 7900 XTX的推理能力为20.47 iterations/second
AMD Radeon RX 7900 XTX的推理能力提升高达15.8倍
